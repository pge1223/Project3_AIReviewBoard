            ...
            return json.dumps(
                {
                    ...
                    "proposal": f"[{speaker}] 제안(비용 20% 절감)",
                ...
                return json.dumps(
                    {
                        ...
                        "proposal": "문서 요약과 학습 추천부터 우선 검증(2주 내 MVP 1건)",
                        "changed_position": False,
                ...
                return json.dumps(
                    {
                        ...
                        "proposal": "문서 요약 하나로 범위를 좁힌 MVP(2주 내 1건 검증)",
            ...
            return json.dumps(
                {
                    ...
                    "proposal": "업무 자동화 전체를 MVP 범위로 제안(2주 내 1건 검증)",
                    "changed_position": False,
