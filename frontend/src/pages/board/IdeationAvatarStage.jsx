    ...
    <div style={{ width: 468, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: 8 }}>
        <AvatarTileFrame
          ...
          videoRefs={videoRefs}
          speaking={!!speakingMap.planning_expert}
          statusText={statusMap.planning_expert}
        />
        <AvatarTileFrame
          speakerId="dev_expert"
          videoRefs={videoRefs}
          speaking={!!speakingMap.dev_expert}
